...
let currentPage = 1;
let currentLength = parseInt($("#select-length-treasury").val()) || 1000;
let currentKeywords = "";

$(document).ready(function () {

    loadListDetailTreasury(1, 1000, "");

});

export const loadListDetailTreasury = (page = 1, length = 1000, keywords = "",) => {
